...
import {
  tokenFanout,
  replayAttribution,
  compactionTraceStream,
} from "../../src/data/diagrams/codex-context-management/chapter-08";
...
<DiagramFlow spec={tokenFanout} lang="en" client:visible />
...
<DiagramSequence spec={replayAttribution} lang="en" client:visible />
...
<DiagramAscii
  lang="en"
  ascii={compactionTraceStream.ascii}
  legend={compactionTraceStream.legend}
  highlights={compactionTraceStream.highlights}
  client:visible
/>

<figure class="wc-article-figure">
  <img src="/books/codex-context-management/assets/semantic-trace-boundary.png" alt="Semantic trace boundary separating compact input, checkpoint installation, future sampling, trace reducers, runtime ledger, and client surfaces" loading="lazy" decoding="async" />
  <figcaption>The trace is valuable because it does not collapse compact input, checkpoint installation, and later sampling into one vague event; each phase remains auditable.</figcaption>
</figure>
