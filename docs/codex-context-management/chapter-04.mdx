...
import {
  fragmentLanes,
  settingsDiff,
} from "../../src/data/diagrams/codex-context-management/chapter-04";
...
<DiagramFlow spec={fragmentLanes} lang="en" client:visible />
...
<figure class="wc-article-figure">
  <img src="/books/codex-context-management/assets/typed-fragment-catalog-board.png" alt="Typed fragment catalog board showing initial context, settings diff, and ContextualUserFragment families" loading="lazy" decoding="async" />
...
<DiagramFlow spec={settingsDiff} lang="en" client:visible />
