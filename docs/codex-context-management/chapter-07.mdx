...
<RolloutReplayScrubber lang="en" client:visible />
...
<figure class="wc-article-figure">
  <img src="/books/codex-context-management/assets/rollout-reconstruction-boundaries.png" alt="Rollout reconstruction scans backward through checkpoints, rollback markers, agent envelopes, user turns, and assistant turns" loading="lazy" decoding="async" />
...
<DiagramFlow spec={reconstructionOutputs} lang="en" client:visible />
