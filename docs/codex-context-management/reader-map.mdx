...
<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/codex-context-reading-routes.png" alt="Three reading routes through the Codex context management book for architects, implementers, and pattern readers" loading="eager" decoding="async" />
