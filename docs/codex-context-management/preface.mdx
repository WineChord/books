...
<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/context-runtime-overview.png" alt="Six owners of Codex context: history ledger, turn envelope, typed fragments, optional planes, compaction, and replay evidence around a prompt projection" loading="eager" decoding="async" />
...
The source snapshot used throughout this book is [`569ff6a1c400bd514ff79f5f1050a684dc3afde3`](https://github.com/openai/codex/tree/569ff6a1c400bd514ff79f5f1050a684dc3afde3). The book is meant to be read without opening the source first. Source links are audit anchors, not homework.
