...
<figure class="wc-article-figure">
  <img src="/books/codex-context-management/assets/history-ledger-normalization.png" alt="History ledger records structured evidence, bounds large outputs, normalizes provider invariants, and projects model-ready history" loading="eager" decoding="async" />
  <figcaption>The ledger records structured evidence first, then derives a provider-safe prompt view; rollback and compaction can clear stale baselines without corrupting the durable record.</figcaption>
</figure>
