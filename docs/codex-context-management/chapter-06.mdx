...
<DiagramSequence spec={compactionHookFlow} lang="en" client:visible />
...
<figure class="wc-article-figure">
  <img src="/books/codex-context-management/assets/compaction-checkpoint-install.png" alt="Codex compaction as checkpoint installation from old history through compact producer and runtime install to replacement history" loading="lazy" decoding="async" />
...
<DiagramFlow spec={remoteCompactionFlow} lang="en" client:visible />
