...
The clearest way to understand compaction is to see history before and after. Square brackets group items chronologically; braces note item type:
...
The pink nodes belong to the provider. The blue nodes belong to Codex. The line between them is the contract: provider produces, runtime installs.
