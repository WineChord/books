...
<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/runtime-boundary-stack.png" alt="Codex context boundary stack from durable ledger, turn-local envelope, injected fragments, optional planes, and replaceable checkpoints to a model-visible prompt" loading="eager" decoding="async" />
