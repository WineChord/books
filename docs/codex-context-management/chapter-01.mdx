...
import {
  ...
  ownerStack,
  lifetimeAxis,
} from "../../src/data/diagrams/codex-context-management/chapter-01";
...
<figure class="wc-article-figure">
  <img src="/books/codex-context-management/assets/runtime-boundary-stack.png" alt="Codex context boundary stack from durable ledger, turn-local envelope, injected fragments, optional planes, and replaceable checkpoints to a model-visible prompt" loading="eager" decoding="async" />
  <figcaption>The core move is to treat the prompt as a rebuildable view over named owners, rather than as the owner of history, policy, tool output, or compaction state.</figcaption>
</figure>
...
<DiagramFlow spec={projectionFlow} lang="en" client:visible />
...
<DiagramAscii
  lang="en"
  ascii={ownerStack.ascii}
  legend={ownerStack.legend}
  highlights={ownerStack.highlights}
  client:visible
/>
...
<DiagramAscii
  lang="en"
  ascii={lifetimeAxis.ascii}
  legend={lifetimeAxis.legend}
  highlights={lifetimeAxis.highlights}
  client:visible
/>
