...
<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/optional-context-budget-board.png" alt="Optional context budget board where skills, plugins, memory, hooks, tool output, and images compete for model window space" loading="eager" decoding="async" />
...
| Images | User or tool-provided images. | Kept in durable history when available; omitted or replaced in the prompt projection when the active model path cannot accept them. |
