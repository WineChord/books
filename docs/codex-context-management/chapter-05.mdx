...
The effective context window is shared between several consumers. A rough allocation diagram makes the relationships visible. Numbers are illustrative and shift with model and configuration:
