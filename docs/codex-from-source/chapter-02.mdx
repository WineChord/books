...
<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/startup-router-narrowing-df64b03.webp" alt="Startup router narrowing path from npm wrapper through invocation dispatch, Rust CLI router, product surfaces, and shared runtime crates" loading="eager" decoding="async" />
