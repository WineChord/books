...
<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/sdk-daemon-remote-control.png" alt="SDK, daemon, and remote-control map comparing protocol clients, process wrappers, lifecycle management, transports, and shared runtime semantics" loading="lazy" decoding="async" />
