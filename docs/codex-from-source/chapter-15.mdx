...
<figure class="wc-article-figure">
  <img src="/books/codex-from-source/assets/sdk-daemon-remote-control.png" alt="chapter 15 hand-drawn architecture figure" loading="lazy" decoding="async" />
  <figcaption>SDKs, daemons, in-process callers, and remote-control bridges have different reach, but they preserve shared protocol semantics.</figcaption>
</figure>
...
<DiagramFlow spec={clientTaxonomy} lang="en" client:visible />
...
<DiagramFlow spec={daemonLifecycle} lang="en" client:visible />
...
<DiagramSequence spec={remoteControlSequence} lang="en" client:visible />
