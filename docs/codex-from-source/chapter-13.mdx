...
<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/sandbox-network-platform-boundary-df64b03.webp" alt="Sandbox and network boundary map showing permission profiles, platform transforms, macOS Seatbelt, Linux Bubblewrap, Windows identities, and managed proxy policy" loading="eager" decoding="async" />
  <figcaption>Containment is selected at runtime from requested action, permission profile, network policy, platform sandbox, and executor backend.</figcaption>
</figure>
...
**Source boundary:** sandbox type selection and platform choice are **verified source** in [`sandboxing/src/manager.rs`](https://github.com/openai/codex/blob/569ff6a1c400bd514ff79f5f1050a684dc3afde3/codex-rs/sandboxing/src/manager.rs#L23), macOS lowering is **verified source** in [`seatbelt.rs`](https://github.com/openai/codex/blob/569ff6a1c400bd514ff79f5f1050a684dc3afde3/codex-rs/sandboxing/src/seatbelt.rs#L31), Linux execution and proxy routing are **verified source** in [`linux-sandbox`](https://github.com/openai/codex/blob/569ff6a1c400bd514ff79f5f1050a684dc3afde3/codex-rs/linux-sandbox/src/main.rs#L4) and [`proxy_routing.rs`](https://github.com/openai/codex/blob/569ff6a1c400bd514ff79f5f1050a684dc3afde3/codex-rs/linux-sandbox/src/proxy_routing.rs#L169), and Windows setup is **verified source** in [`windows-sandbox-rs`](https://github.com/openai/codex/blob/569ff6a1c400bd514ff79f5f1050a684dc3afde3/codex-rs/windows-sandbox-rs/src/setup.rs#L85). Any cross-platform equivalence language is intentionally framed as a **surrounding contract inference**; the chapter does not claim the operating systems enforce identical sandboxes.
