...
<ContainmentBoundaryExplorer lang="en" client:visible />
...
<figure class="wc-article-figure">
  <img src="/books/codex-from-source/assets/sandbox-network-platform-boundary.png" alt="chapter 13 hand-drawn architecture figure" loading="lazy" decoding="async" />
...
<DiagramFlow spec={policyTransformEnforcement} lang="en" client:visible />
