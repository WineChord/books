...
<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/sandbox-network-platform-boundary.png" alt="Sandbox and network boundary map showing permission profiles, platform transforms, macOS Seatbelt, Linux Bubblewrap, Windows identities, and managed proxy policy" loading="lazy" decoding="async" />
