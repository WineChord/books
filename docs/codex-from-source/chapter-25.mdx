...
<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/ci-policy-governance-lanes.png" alt="CI governance lanes connecting policy checks, generated artifacts, Rust tests, Bazel verification, and release protection" loading="lazy" decoding="async" />
