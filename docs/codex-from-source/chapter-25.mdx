...
<figure class="wc-article-figure">
  <img src="/books/codex-from-source/assets/ci-policy-governance-lanes.png" alt="chapter 25 hand-drawn architecture figure" loading="lazy" decoding="async" />
...
<DiagramFlow spec={mergeConfidenceFanout} lang="en" client:visible />
...
<DiagramFlow spec={ciLaneMap} lang="en" client:visible />
...
<DiagramFlow spec={generatedDriftStateMachine} lang="en" client:visible />
