...
import { configurationStack, authManagerSnapshot } from "../../src/data/diagrams/codex-from-source/chapter-03";
...
<figure class="wc-article-figure">
  <img src="/books/codex-from-source/assets/config-auth-constraint-stack.png" alt="chapter 03 hand-drawn architecture figure" loading="lazy" decoding="async" />
...
<DiagramFlow spec={configurationStack} lang="en" client:visible />
...
<DiagramFlow spec={authManagerSnapshot} lang="en" client:visible />
