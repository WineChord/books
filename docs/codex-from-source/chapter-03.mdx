...
<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/config-auth-constraint-stack.png" alt="Configuration and authentication constraint stack showing defaults, trusted project config, auth snapshot, managed requirements, and resolved permissions" loading="lazy" decoding="async" />
