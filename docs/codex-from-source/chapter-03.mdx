...
> **Reading Contract:** Use this chapter to read configuration as constraints. Track how auth, policy, managed requirements, profiles, and environment facts become the envelope that later code must obey.

<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/config-auth-constraint-stack.webp" alt="Configuration and authentication constraint stack showing defaults, trusted project config, auth snapshot, managed requirements, and resolved permissions" loading="eager" decoding="async" />
  <figcaption>Configuration is not decoration; it compiles defaults, profiles, auth, managed requirements, and permissions into the contract a turn must obey.</figcaption>
</figure>
...
**Source boundary:** claims about resolved permissions are **verified source** through [`config/mod.rs`](https://github.com/openai/codex/blob/569ff6a1c400bd514ff79f5f1050a684dc3afde3/codex-rs/core/src/config/mod.rs#L236), permission compilation is **verified source** through [`permissions.rs`](https://github.com/openai/codex/blob/569ff6a1c400bd514ff79f5f1050a684dc3afde3/codex-rs/core/src/config/permissions.rs#L300), and managed feature gates are **verified source** through [`managed_features.rs`](https://github.com/openai/codex/blob/569ff6a1c400bd514ff79f5f1050a684dc3afde3/codex-rs/core/src/config/managed_features.rs#L25). The chapter's "runtime envelope" language is a **surrounding contract inference** from those resolved shapes and from the public permission profile in [`app-server-protocol`](https://github.com/openai/codex/blob/569ff6a1c400bd514ff79f5f1050a684dc3afde3/codex-rs/app-server-protocol/src/protocol/v2/permissions.rs#L375), not a claim about hidden service internals.
