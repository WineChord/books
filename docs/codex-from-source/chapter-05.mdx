...
<figure class="wc-article-figure">
  <img src="/books/codex-from-source/assets/thread-session-durable-state.png" alt="chapter 05 hand-drawn architecture figure" loading="lazy" decoding="async" />
  <figcaption>Thread identity, live session ownership, queues, history, and rollout evidence solve different persistence problems and should not collapse into one transcript.</figcaption>
</figure>
