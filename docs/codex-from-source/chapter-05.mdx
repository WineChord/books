...
<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/thread-session-durable-state.png" alt="Durable thread state map separating thread identity, session facade, queues, history, rollout, projections, resume, fork, and rollback" loading="lazy" decoding="async" />
