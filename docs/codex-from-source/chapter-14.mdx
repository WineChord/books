...
<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/app-server-contract-bridge.webp" alt="JSON-RPC app-server bridge that normalizes transports, serializes resources, maps runtime events, and lets clients rejoin shared threads" loading="eager" decoding="async" />
