...
<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/publication-discipline-pipeline-df64b03.webp" alt="Publication pipeline showing claim discipline, pinned evidence, figure checks, bilingual parity, automated validation, and release gating" loading="eager" decoding="async" />
