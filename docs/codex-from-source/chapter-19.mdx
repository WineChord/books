...
<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/compatibility-lane-adapters.png" alt="Compatibility lanes showing external config migration, session import, adapters, and legacy state protection" loading="lazy" decoding="async" />
