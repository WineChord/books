...
> **Reading Contract:** Use this chapter to understand multi-agent coordination. Track graph edges, parent and child thread boundaries, live updates, trace graphs, and the ownership of outcomes.

<figure class="wc-article-figure">
  <img src="/books/codex-from-source/assets/multi-agent-coordination-graph.png" alt="chapter 20 hand-drawn architecture figure" loading="lazy" decoding="async" />
...
<DiagramFlow spec={coordinationTopology} lang="en" client:visible />
...
<DiagramFlow spec={liveAndTraceGraphs} lang="en" client:visible />
