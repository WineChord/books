...
<figure class="wc-article-figure">
  <img src="/books/codex-from-source/assets/tool-routing-dispatch-map.png" alt="chapter 09 hand-drawn architecture figure" loading="lazy" decoding="async" />
  <figcaption>A model-visible tool spec is only the first gate; routing, registry lookup, orchestration, and result shaping decide the real side effect.</figcaption>
</figure>
...
<DiagramFlow spec={toolSpecPlanner} lang="en" client:visible />
