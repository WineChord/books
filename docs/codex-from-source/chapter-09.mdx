...
<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/tool-routing-dispatch-map.webp" alt="Tool routing and dispatch map separating model-visible specs, registry handlers, router validation, orchestration, policy, and result shaping" loading="eager" decoding="async" />
