...
> **Reading Contract:** Use this chapter to read the TUI as a projection. Track event rendering, layout state, streaming Markdown, approvals, and why the terminal is not a second runtime.

<figure class="wc-article-figure">
  <img src="/books/codex-from-source/assets/tui-event-renderer.png" alt="chapter 16 hand-drawn architecture figure" loading="lazy" decoding="async" />
  <figcaption>The TUI is a projection, not the owner of truth: session events become render state, streaming Markdown, approval controls, and terminal feedback.</figcaption>
</figure>
...
<DiagramFlow spec={startupPath} lang="en" client:visible />
...
<DiagramFlow spec={spatialModel} lang="en" client:visible />
...
<DiagramFlow spec={eventSources} lang="en" client:visible />
...
<DiagramFlow spec={streamingMarkdown} lang="en" client:visible />
