...
<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/tui-event-renderer-df64b03.png" alt="TUI event renderer map showing terminal input, app commands, chat cells, bottom pane state, streaming Markdown, approval modals, and runtime events" loading="lazy" decoding="async" />
