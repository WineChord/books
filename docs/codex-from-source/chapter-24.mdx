...
<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/release-artifact-conveyor.png" alt="Release artifact conveyor moving Rust workspace outputs through native binaries, npm wrappers, platform packages, signatures, and checksums" loading="lazy" decoding="async" />
