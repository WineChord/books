...
<figure class="wc-article-figure">
  <img src="/books/codex-from-source/assets/release-artifact-conveyor.png" alt="chapter 24 hand-drawn architecture figure" loading="lazy" decoding="async" />
...
<DiagramFlow spec={releaseSurfaceMap} lang="en" client:visible />
...
<DiagramSequence spec={installerArtifactSequence} lang="en" client:visible />
...
<DiagramFlow spec={nativeDependencyQuarantine} lang="en" client:visible />
