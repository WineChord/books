...
<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/tool-provenance-deferred-569ff6a1.webp" alt="MCP and client tools passing through canonical names, provenance, direct spec, deferred tool search, unavailable placeholders, and route-back handler lookup" loading="lazy" decoding="async" width="1672" height="941" />
  <figcaption>Tool provenance keeps discovery, model-visible naming, deferred exposure, and route-back handler lookup separate.</figcaption>
</figure>
...
<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/tool-router-payload-gate-569ff6a1.webp" alt="Tool router converting function, custom, local shell, tool search, and MCP response items into payload kinds before handler matching" loading="lazy" decoding="async" width="1672" height="941" />
  <figcaption>The router gate is where a model-visible call becomes a classified payload before any runtime handler executes it.</figcaption>
</figure>
