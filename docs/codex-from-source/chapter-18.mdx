...
<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/extension-packaging-plane.png" alt="Extension packaging plane separating skills, plugins, connectors, typed extensions, trust checks, and context injection" loading="lazy" decoding="async" />
