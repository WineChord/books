...
<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/reusable-agent-pattern-index.png" alt="Reusable agent pattern index connecting typed boundaries, queue-pair runtime, tools, approvals, sandboxes, extensions, and shared surfaces" loading="lazy" decoding="async" />
