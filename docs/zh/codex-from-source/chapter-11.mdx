...
<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/patch-protocol-workbench.png" alt="Patch 协议工作台：展示结构化 patch grammar、safety review、approval、application、diff tracking 和 failure feedback" loading="lazy" decoding="async" />
