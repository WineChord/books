...
<figure class="wc-article-figure">
  <img src="/books/codex-from-source/assets/patch-protocol-workbench.png" alt="chapter 11 page hand-drawn architecture figure" loading="lazy" decoding="async" />
  <figcaption>Patch handling 把文件编辑变成协议：structured diff、permission check、application 和 turn-level attribution 都保持可见。</figcaption>
</figure>
