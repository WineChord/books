...
<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/hooks-approval-gates.png" alt="Hooks 与审批门：展示 pre-tool hooks、permission policy、自动 review、人工决策、sandbox 和 post-tool feedback" loading="lazy" decoding="async" />
