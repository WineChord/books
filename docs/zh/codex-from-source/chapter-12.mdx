...
<ApprovalLadder lang="zh" client:visible />
...
<figure class="wc-article-figure">
  <img src="/books/codex-from-source/assets/hooks-approval-gates.png" alt="chapter 12 page hand-drawn architecture figure" loading="lazy" decoding="async" />
  <figcaption>Hooks 和 approvals 是风险门禁：在不可逆副作用发生前，它们可以 annotate、delay、deny 或 continue。</figcaption>
</figure>
...
<DiagramFlow spec={gateStack} lang="zh" client:visible />
...
<DiagramSequence spec={commandThroughGates} lang="zh" client:visible />
