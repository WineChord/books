...
<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/pinned-source-evidence-map.png" alt="固定源码证据索引：把章节论断映射到已核验 owner、公开源码锚点和审计规则" loading="lazy" decoding="async" />
