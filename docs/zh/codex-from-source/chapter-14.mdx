...
<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/app-server-contract-bridge.webp" alt="JSON-RPC app-server 契约桥：统一 transport、按资源串行化、映射 runtime event，并让客户端重新接入共享 thread" loading="eager" decoding="async" />
