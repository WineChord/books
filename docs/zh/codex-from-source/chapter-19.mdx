...
> **阅读契约：** 用本章把 migration 当成架构。跟住 compatibility lanes、session import、legacy shapes，以及 adapters 如何防止旧状态污染新契约。

<figure class="wc-article-figure">
  <img src="/books/codex-from-source/assets/compatibility-lane-adapters.png" alt="chapter 19 page hand-drawn architecture figure" loading="lazy" decoding="async" />
...
<DiagramFlow spec={migrationPipeline} lang="zh" client:visible />
...
<DiagramSequence spec={sessionImportFlow} lang="zh" client:visible />
