...
<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/history-surface-fanout-569ff6a1.webp" alt="History surface fanout：durable transcript、model projection、UI history、resume reconstruction、fork baseline 与 audit evidence 分流" loading="lazy" decoding="async" width="1672" height="941" />
  <figcaption>Imported history 必须说明自己在重建哪一层：transcript evidence、model projection、UI history，还是 resume baseline。</figcaption>
</figure>
...
<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/replay-resume-fork-569ff6a1.webp" alt="Replay、resume 与 fork path：从 stored history、forked items、rollback state 和 continuation baseline 重建 thread" loading="lazy" decoding="async" width="1672" height="941" />
  <figcaption>Session import 的安全点在于 imported items 变成 forked native baseline，而不是外部 runtime replay。</figcaption>
</figure>
