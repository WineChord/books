...
<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/compatibility-lane-adapters.png" alt="兼容性通道：展示外部配置迁移、session import、adapter 与旧状态保护" loading="lazy" decoding="async" />
