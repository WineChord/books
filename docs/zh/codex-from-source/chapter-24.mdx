...
<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/release-artifact-conveyor.png" alt="发布产物传送带：把 Rust workspace 输出送过 native binaries、npm wrappers、平台包、签名和 checksum" loading="lazy" decoding="async" />
