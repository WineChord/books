...
import {
  releaseSurfaceMap,
  installerArtifactSequence,
  nativeDependencyQuarantine,
} from "../../../src/data/diagrams/codex-from-source/chapter-24";

# 第 24 章：打包、发布与原生依赖

<ReleaseArtifactConveyor lang="zh" client:visible />
...
<figure class="wc-article-figure">
  <img src="/books/codex-from-source/assets/release-artifact-conveyor.png" alt="chapter 24 page hand-drawn architecture figure" loading="lazy" decoding="async" />
...
<DiagramFlow spec={releaseSurfaceMap} lang="zh" client:visible />
...
<DiagramSequence spec={installerArtifactSequence} lang="zh" client:visible />
...
<DiagramFlow spec={nativeDependencyQuarantine} lang="zh" client:visible />
