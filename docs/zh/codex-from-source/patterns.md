...
<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/reusable-agent-pattern-index-df64b03.png" alt="可复用 agent 模式索引：连接 typed boundaries、queue-pair runtime、tools、approvals、sandboxes、extensions 与共享 surfaces" loading="lazy" decoding="async" />
