...
<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/reusable-agent-pattern-index-df64b03.webp" alt="可复用 agent 模式索引：连接 typed boundaries、queue-pair runtime、tools、approvals、sandboxes、extensions 与共享 surfaces" loading="eager" decoding="async" />
...
模式必须贴住证据才有价值。每个模式对应的章节都提供证据表、固定到公开 commit 的源码链接、面向初学者的解释和一个阅读练习。想一次性回到源码，请看 [源码索引](source-atlas.html)。
