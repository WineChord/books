...
<figure class="wc-article-figure">
  <img src="/books/codex-from-source/assets/sdk-daemon-remote-control.png" alt="chapter 15 page hand-drawn architecture figure" loading="lazy" decoding="async" />
  <figcaption>SDK、daemon、in-process caller 和 remote-control bridge 的触达方式不同，但保持同一套协议语义。</figcaption>
</figure>
