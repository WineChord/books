...
<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/sdk-daemon-remote-control-df64b03.webp" alt="SDK、daemon 与远程控制图：比较 protocol clients、process wrappers、lifecycle management、transports 和共享 runtime semantics" loading="eager" decoding="async" />
