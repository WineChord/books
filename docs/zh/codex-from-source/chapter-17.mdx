...
<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/mcp-trust-plane.png" alt="MCP 信任平面：分开 server provenance、清洗后的 tool name、discovery、routing、elicitation 与结构化 observation" loading="lazy" decoding="async" />
