...
<McpTrustPlane lang="zh" client:visible />

> **阅读契约：** 用本章画出 MCP trust plane。跟住 server provenance、tool discovery、routing，以及外部工具如何留在受控边界之后。

<figure class="wc-article-figure">
  <img src="/books/codex-from-source/assets/mcp-trust-plane.png" alt="chapter 17 page hand-drawn architecture figure" loading="lazy" decoding="async" />
...
<DiagramFlow spec={mcpBoundary} lang="zh" client:visible />
