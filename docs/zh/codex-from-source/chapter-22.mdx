...
<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/memory-side-channel-governance.png" alt="Memory 旁路治理图：分开 read prompt、write pipeline、citation、lock、redaction、consolidation 与 storage" loading="lazy" decoding="async" />
