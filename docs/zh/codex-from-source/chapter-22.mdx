...
<figure class="wc-article-figure">
  <img src="/books/codex-from-source/assets/memory-side-channel-governance.png" alt="chapter 22 page hand-drawn architecture figure" loading="lazy" decoding="async" />
...
<DiagramFlow spec={memoryReadWritePaths} lang="zh" client:visible />
...
<DiagramFlow spec={citationProvenanceFlow} lang="zh" client:visible />
...
<DiagramSequence spec={stageTwoConsolidation} lang="zh" client:visible />
