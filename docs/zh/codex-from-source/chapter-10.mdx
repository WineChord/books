...
<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/shell-exec-filesystem-boundary.png" alt="Shell 与文件系统执行边界：展示 tool calls、exec policy、approval、sandbox selection、exec-server process、filesystem handler 和有序输出" loading="lazy" decoding="async" />
