...
<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/tool-routing-dispatch-map.webp" alt="工具路由与分发图：分开模型可见 spec、registry handler、router validation、orchestration、policy 和 result shaping" loading="eager" decoding="async" />
