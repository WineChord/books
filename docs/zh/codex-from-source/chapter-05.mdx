...
<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/thread-session-durable-state-df64b03.webp" alt="持久 thread 状态图：分开 thread identity、session facade、queues、history、rollout、projection、resume、fork 与 rollback" loading="eager" decoding="async" />
