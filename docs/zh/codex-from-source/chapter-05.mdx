...
<figure class="wc-article-figure">
  <img src="/books/codex-from-source/assets/thread-session-durable-state.png" alt="chapter 05 page hand-drawn architecture figure" loading="lazy" decoding="async" />
  <figcaption>Thread identity、live session、queues、history 和 rollout evidence 解决不同持久化问题，不能退化成一份 transcript。</figcaption>
</figure>
