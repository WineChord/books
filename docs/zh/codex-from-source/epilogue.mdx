...
<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/transferable-agent-runtime-lessons-df64b03.png" alt="可迁移 agent runtime 经验图：从 typed contracts 穿过 authority、rollout、projections、memory 和 executable governance" loading="lazy" decoding="async" />
