...
<figure class="wc-article-figure">
  <img src="/books/codex-from-source/assets/transferable-agent-runtime-lessons.png" alt="epilogue page hand-drawn architecture figure" loading="lazy" decoding="async" />
...
<DiagramFlow spec={finalMentalModel} lang="zh" client:visible />
