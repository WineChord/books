...
<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/generated-contract-drift-check.png" alt="生成契约漂移检查：连接 Rust 类型、导出 schema、已提交产物、CI 失败和客户端 API 审核" loading="lazy" decoding="async" />
