...
<GeneratedContractDriftViewer lang="zh" client:visible />
...
<figure class="wc-article-figure">
  <img src="/books/codex-from-source/assets/generated-contract-drift-check.png" alt="chapter 23 page hand-drawn architecture figure" loading="lazy" decoding="async" />
...
<DiagramFlow spec={buildSurfaceMap} lang="zh" client:visible />
...
<DiagramFlow spec={developerFlow} lang="zh" client:visible />
...
<DiagramSequence spec={schemaDriftSequence} lang="zh" client:visible />
