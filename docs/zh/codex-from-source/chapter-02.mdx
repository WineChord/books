...
<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/startup-router-narrowing-df64b03.png" alt="启动路由收窄图：从 npm wrapper 穿过 invocation dispatch、Rust CLI router、product surfaces 和 shared runtime crates" loading="lazy" decoding="async" />
