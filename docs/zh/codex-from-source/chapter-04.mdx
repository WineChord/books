...
<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/protocol-boundary-taxonomy-df64b03.webp" alt="协议边界分类图：覆盖 submissions、operations、events、items、app-server messages、generated schemas 和 compatibility" loading="eager" decoding="async" />
