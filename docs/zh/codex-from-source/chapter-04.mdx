...
<figure class="wc-article-figure">
  <img src="/books/codex-from-source/assets/protocol-boundary-taxonomy.png" alt="chapter 04 page hand-drawn architecture figure" loading="lazy" decoding="async" />
...
<DiagramSequence spec={submissionLifecycle} lang="zh" client:visible />
...
<DiagramFlow spec={appServerPipeline} lang="zh" client:visible />
...
<DiagramFlow spec={eventToItemMapping} lang="zh" client:visible />
...
<DiagramFlow spec={partOneGates} lang="zh" client:visible />
