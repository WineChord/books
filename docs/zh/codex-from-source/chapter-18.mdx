...
<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/extension-packaging-plane.png" alt="扩展打包平面：分开 skills、plugins、connectors、typed extensions、trust checks 与 context injection" loading="lazy" decoding="async" />
