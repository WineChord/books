...
<ExtensionProvenance lang="zh" client:visible />

> **阅读契约：** 用本章把 skills、plugins、connectors 和 apps 读成打包后的 extension planes。分开看 metadata、trust、loading 和 context injection。

<figure class="wc-article-figure">
  <img src="/books/codex-from-source/assets/extension-packaging-plane.png" alt="chapter 18 page hand-drawn architecture figure" loading="lazy" decoding="async" />
...
<DiagramFlow spec={extensionPlanes} lang="zh" client:visible />
