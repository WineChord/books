...
<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/ci-policy-governance-lanes.png" alt="CI 治理通道：连接策略检查、生成产物、Rust 测试、Bazel 校验和发布保护" loading="lazy" decoding="async" />
