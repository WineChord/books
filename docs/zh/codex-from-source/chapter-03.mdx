...
<figure class="wc-article-figure">
  <img src="/books/codex-from-source/assets/config-auth-constraint-stack.png" alt="chapter 03 page hand-drawn architecture figure" loading="lazy" decoding="async" />
...
<DiagramFlow spec={configurationStack} lang="zh" client:visible />
...
<DiagramFlow spec={authManagerSnapshot} lang="zh" client:visible />
