...
<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/config-auth-constraint-stack.png" alt="配置与认证约束栈：展示 defaults、可信项目配置、auth snapshot、managed requirements 和 resolved permissions" loading="lazy" decoding="async" />
