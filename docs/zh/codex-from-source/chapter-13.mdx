...
<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/sandbox-network-platform-boundary.png" alt="Sandbox 与网络边界图：展示 permission profiles、平台 transform、macOS Seatbelt、Linux Bubblewrap、Windows identities 和 managed proxy policy" loading="lazy" decoding="async" />
