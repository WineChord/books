import ContainmentBoundaryExplorer from "../../../src/components/visual/ContainmentBoundaryExplorer.tsx";
import DiagramFlow from "../../../src/components/visual/diagrams/DiagramFlow.tsx";
import { policyTransformEnforcement } from "../../../src/data/diagrams/codex-from-source/chapter-13";

# 第 13 章：Sandboxes、网络策略与平台边界

<ContainmentBoundaryExplorer lang="zh" client:visible />
...
<figure class="wc-article-figure">
  <img src="/books/codex-from-source/assets/sandbox-network-platform-boundary.png" alt="chapter 13 page hand-drawn architecture figure" loading="lazy" decoding="async" />
...
<DiagramFlow spec={policyTransformEnforcement} lang="zh" client:visible />
