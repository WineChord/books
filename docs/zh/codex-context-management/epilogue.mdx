...
<figure class="wc-article-figure">
  <img src="https://cdn.jsdelivr.net/gh/WineChord/typora-images/img/context-discipline-route-map.png" alt="Context discipline route map：envelope、ledger、fragments、budgets、projection、checkpoint、replay 与 client view 的全书路线图" loading="eager" decoding="async" />
