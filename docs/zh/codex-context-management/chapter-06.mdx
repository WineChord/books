...
<figure class="wc-article-figure">
  <img src="/books/codex-context-management/assets/compaction-checkpoint-install.png" alt="Codex compaction checkpoint 安装流程：旧历史经过 compact producer 与 runtime install 变成 replacement history" loading="lazy" decoding="async" />
  <figcaption>生产 compacted 材料的可以是本地模型或远程端点，但语义边界仍在 Codex：过滤、放置、记录与安装 replacement history 都由 runtime 完成。</figcaption>
</figure>
