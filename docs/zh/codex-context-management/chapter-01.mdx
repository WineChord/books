...
<ContextLifecycleExplorer lang="zh" client:visible />
...
<figure class="wc-article-figure">
  <img src="/books/codex-context-management/assets/runtime-boundary-stack.png" alt="Codex 上下文边界栈：durable ledger、turn-local envelope、injected fragments、optional planes 与 replaceable checkpoints 投影成模型可见 prompt" loading="eager" decoding="async" />
...
<DiagramFlow spec={projectionFlow} lang="zh" client:visible />
