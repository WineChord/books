...
<figure class="wc-article-figure">
  <img src="/books/codex-context-management/assets/turn-envelope-resolution.png" alt="Turn envelope 解析图：identity、workspace、instructions、policy、capabilities、modes 与 telemetry 汇入 TurnContext" loading="eager" decoding="async" />
...
<DiagramFlow spec={envelopeFlow} lang="zh" client:visible />
...
<DiagramSequence spec={modelSwitchSequence} lang="zh" client:visible />
