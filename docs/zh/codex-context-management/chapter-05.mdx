...
<figure class="wc-article-figure">
  <img src="/books/codex-context-management/assets/optional-context-budget-board.png" alt="Optional context budget board：skills、plugins、memory、hooks、tool output 与 images 竞争模型窗口空间" loading="eager" decoding="async" />
...
<DiagramFlow spec={optionalContextSelection} lang="zh" client:visible />
...
<DiagramFlow spec={toolOutputPolicy} lang="zh" client:visible />
